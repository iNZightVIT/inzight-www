...
<div class="row">
  ...
  <div class="col-md-6">
    <h5><a href="https://www.stat.auckland.ac.nz/people/shu454">Shengwei (Wilson) Hu</a></h5>

    <p>
      Wilson began working on <a href="http://lite.docker.stat.auckland.ac.nz">iNZight Lite</a> in 2014.
      His work involves maintaining and implementing new features in the program,
      and fixing any bugs that show up.
      Wilson is currently studying towards a PhD is statistics here at the University of Auckland.
    </p>
    <p><strong>Core responsibilities:</strong></p>
    <ul>
