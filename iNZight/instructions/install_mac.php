...
<div class="panel panel-danger space-above">
  <div class="panel-heading">
    <h5 class="panel-title">Unknown Developer Warnings</h5>
  </div>
  <div class="panel-body">
    If you are unable to open any of the files due to "Unknown Developer",
    simply <strong>Right-click</strong> the file and select <strong>Open</strong>.
  </div>
</div>
...
<p>
  To run iNZight, just go to <strong>Applications</strong> &gt; <strong>iNZightVIT</strong>,
  and double-click <strong>iNZight</strong> to begin.
  <a href="<?php echo $rel; ?>img/install/mac/open_folder.jpg" target="_blank" class="thumb">
    <img src="<?php echo $rel; ?>img/install/mac/open_folder.jpg">
  </a>
</p>
