...
This adjusts the overall transparency of points, where 0 is fully visible, to 1 is fully invisible. This can be specified by variable and opacity can be in reverse order. 
